...
from src.models.modules.resnet import res_block
...
class Net(nn.Module):
    ...
    def forward(self,x):
        ...
        x=self.unet_block1(x,skip2,out_2)
        
        out_1 = self.out_1(x)
        skip1 = self.skip_1(skip1,out_1)
        x=self.unet_block4(x,skip1,out_1)
